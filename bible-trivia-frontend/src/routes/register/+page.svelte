...
<svelte:head>
  <title>Create Account - Bible Trivia Expedition</title>
</svelte:head>
      ...
      <div class="max-w-md w-full mx-auto bg-white bg-opacity-95 p-10 rounded-2xl shadow-2xl transform transition-all duration-300 hover:shadow-3xl login-container" in:fade={{ duration: 800, delay: 200 }}>
        <div class="text-center mb-8">
          ...
          <p class="text-lg text-gray-600 mt-2">
            Begin your <span class="font-semibold text-[#5433ff]">Biblical Journey</span> today
          </p>
        </div>
        ...
        <div class="mt-8 text-center">
          <p class="text-sm text-gray-600">
            ...
            <a href="/login" class="font-medium text-[#5433ff] hover:text-[#4a2ee0] transition-colors duration-300">
              Sign in here
            </a>
          </p>
        </div>
